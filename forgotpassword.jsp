            ...
            <div id="content">
                ...
                <form action="forgotpassword.jsp">
                    <div class="form_settings">
                        <p>
                            <span>User Name :</span><input class="contact" type="text" name="username" value="" />
                        </p>
                        <p style="padding-top: 15px">
                            <span>&nbsp;</span><input class="submit" type="submit" name="contact_submitted" value="Get Password" />
                        </p>
                    </div>
                </form>
                ...
                <%
                    ...
                    if (username != null) {
                        ...
                        if (user != null) {
                            ...
                            MailService.mailsend("Your Account Password is:", user.getPassword(), user.getEmail());
